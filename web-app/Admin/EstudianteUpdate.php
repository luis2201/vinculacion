    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Actualizar datos del Estudiante</h1>              
            </div><!-- /.col -->            
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="col-sm-8" style="margin: auto;">
              <div class="card mb-3">
                <div class="card-header text-right bg-primary" style="padding: 2px;">
                  <a href="Estudiante.php"><button type="button" class="btn btn-outline-light btn-sm"><i class="fas fa-backspace"></i> Volver</button></a>
                </div>
                <?php 
                  $result = $estudiante->view_estudiante_business();                  
                  if(count($result)==0){
                ...
                ?>
                <div class="card-body">
                  <form class="frmAction" action="<?php echo __SERVER__; ?>ajax/updateEstudianteAjax.php?>" method="POST" data-form="update" enctype="multipart/form-data" autocomplete="off">                    
                    <input type="hidden" name="idestudiante" id="idestudiante" value="<?php echo $estudiante->encryption($row['idestudiante']); ?>">
                    <div class="form-row">
                        ...
                        <select name="idcarrera" id="idcarrera" class="form-control">
                          <?php
                            ...
                            foreach ($result as $carreras) {
                              echo '<option value="'.$estudiante->encryption($carreras["idcarrera"]);
