    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Actualizar texto de la Pregunta</h1>              
            </div><!-- /.col -->            
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
          ...
          <div class="row">
            <div class="col-sm-8" style="margin: auto;">
              <div class="card mb-3">
                ...
                <?php 
                  $result = $pregunta->view_pregunta_business();                  
                  if(count($result)==0){
                ...
                ?>
                <div class="card-body">
                  <form class="frmAction" action="<?php echo __SERVER__; ?>ajax/updatePreguntaAjax.php?>" method="POST" data-form="update" enctype="multipart/form-data" autocomplete="off">
                    <input type="hidden" name="idpregunta" id="idpregunta" value="<?php echo $pregunta->encryption($row['idpregunta']); ?>">                    
                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="pregunta">Nombre de la Carrera</label>
                        <input type="text" name="pregunta" id="pregunta" class="form-control" placeholder="Carrera" value="<?php echo $row['pregunta']; ?>">
                      </div>                      
                    </div>                    
                    <div class="form-row"> 
