    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Registro de Tipo de Requerimiento</h1>              
            </div><!-- /.col -->            
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
          ...
          <div class="row">
            <div class="col-sm-8" style="margin: auto;">
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <form class="frmAction" action="<?php echo __SERVER__; ?>ajax/insertTipoRequerimientoAjax.php?>" method="POST" data-form="insert" enctype="multipart/form-data" autocomplete="off">                    
                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="tipo">Requerimiento</label>
                        <input type="text" name="tipo" id="tipo" class="form-control" placeholder="Requerimiento">
                      </div>                      
                    </div>                    
                    <div class="form-row">
