    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Datos del Tipo de Requerimiento</h1>              
            </div><!-- /.col -->            
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                      <h1 class="display-6"><?php echo $row['tipo']; ?></h1>                      
                      <p class="lead"><?php echo 'Equivalencia en Horas: '.$row['horas']; ?></span></p>
