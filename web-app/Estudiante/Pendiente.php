                ...
                <div class="card-body">
                  <table id="tbLista" class="table table-responsive-sm table-striped table-hover" style="font-size: 12px;">
                    ...
                    <tbody>
                      <?php 
                        $i = 1;
                        $result = $requerimiento->consulta_pendiente_requerimiento_estudiante_business();
                      ...
                      <tr>
                        ...
                        <th class="text-center"><?php echo $row['horas'] ?></th>
                        ...
                        <th class="text-center" style="padding:0.5%; width: 50px; margin: auto;">
                          <div class="row">
                            <div class="col-sm-12" style="padding:0; margin: 0">                                                              
                              <a href="PendienteView.php?id=<?php echo $requerimiento->encryption($row['idrequerimiento']); ?>"><button type="button" class="btn btn-sm btn-warning"><i class="far fa-eye"></i></button></a>
                            </div>                            
                          </div>
                        </th>
                      </tr>
