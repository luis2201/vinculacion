    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Datos del Estudiante</h1>              
            </div><!-- /.col -->            
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
          ...
          <div class="row">
            <div class="col-sm-10" style="margin: auto;">
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <?php 
                    $result = $requerimiento->view_pendiente_business();
                    if(count($result)){
                  ...
                  <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                      ...
                      <p class="lead"><?php echo 'Tutor: '.$row['tutor']; ?></p>
                      <p class="lead"><?php echo 'Cliente: '.$row['cliente']; ?></p>
                      <p class="lead"><?php echo 'Correo: '.$row['correo']; ?></p>
                      <p class="lead"><?php echo 'Tel&eacute;no: '.$row['telefono']; ?></p>
