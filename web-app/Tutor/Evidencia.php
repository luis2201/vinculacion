                ...
                <div class="card-body">
                  <table id="tbLista" class="table table-responsive-sm table-striped table-hover" style="font-size: 12px;">
                    ...
                    <tbody>
                      <?php 
                        $i = 1;
                        $result = $evidencia->consulta_evidencia_tutor_estudiante_business();
                      ...
                      <tr>
                        ...
                        <th class="text-center" style="padding:0.5%; width: 50px; margin: auto;">
                          <div class="row">
                            ...
                            <div class="col-sm-6" style="padding:0; margin: 0">
                              <?php if($row['estado']==0){ ?>
                              <form class="frmAction" action="<?php echo __SERVER__; ?>ajax/estadoEvidenciaAjax.php" method="POST" data-form="estado" enctype="multipart/form-data" autocomplete="off">
                                <input type="hidden" id="evidencia" name="evidencia" value="<?php echo $row['evidencia']; ?>">
