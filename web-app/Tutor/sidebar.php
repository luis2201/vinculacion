          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">            
            ...
            <li class="nav-item has-treeview">
              <a href="#" class="nav-link">              
                <p>
                  Requerimiento                  
                  <span class="badge badge-info right"><?php echo count($tutor->tutor_estudiante_requerimiento_pendiente_business()); ?> (Pendiente)</span>
                </p>
              </a>
            ...
            <li class="nav-item has-treeview">
              <a href="CalificacionAvance.php" class="nav-link">              
                <p>
                  Calificaci&oacute;n de Avance
                </p>
              </a>              
            </li>
	    <li class="nav-item has-treeview">
              <a href="ReporteHoras.php" class="nav-link">              
                <p>
                  Reporte de Horas
                </p>
              </a>              
